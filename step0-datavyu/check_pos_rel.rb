...
pri_col_name = 'position' # name of primary coder's column
rel_col_name = 'position_rel' # name of reliability coder's column
...
disagree_col_name = 'pos_disagree' # name of column to display disagreements, leave blank to skip
clean_col_name = 'pos_clean' # name of column to copy primary coder's column (to make changes after resolving disagreements)
