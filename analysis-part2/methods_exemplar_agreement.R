...
lims <- as_hms(c('10:00:00', '19:30:00'))
hour_breaks = as_hms(c('10:00:00', '11:00:00', '12:00:00', '13:00:00', '14:00:00', '15:00:00', '16:00:00', '17:00:00', '18:00:00', '19:00:00'))
label_breaks = c("10am","11am","12pm","1pm","2pm","3pm","4pm","5pm","6pm","7pm")
...
ggplot() + 
  ...
  scale_x_time(breaks = hour_breaks, labels = label_breaks, limits = lims, name = "") + 
